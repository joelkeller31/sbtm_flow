...
from distributions import Sampleable, Density, Gaussian, BetaTarget

""" This document contains the path classes for the FPE Flow Project"""
...
class SquareRootBeta(Beta):
    ...
    def __call__(self, t: torch.Tensor) -> torch.Tensor:
        ...
        Returns:
            - beta_t (num_samples, 1)
        """ 
        return torch.sqrt(1 - t)  # Add small epsilon
    ...
    def dt(self, t: torch.Tensor) -> torch.Tensor:
        ...
        Returns:
            - d/dt alpha_t (num_samples, 1)
        """ 
        return -0.5 / torch.sqrt(1 - t + 1e-6)